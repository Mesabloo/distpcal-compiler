...
namespace GuardedPlusCal
  ...
  theorem Statement.reducing.receive.intro.{u} {σ σ' : LocalState.{u} false} {ε : List Behavior.{u}} {pos chan ref}
    (h : ∃ M T F M' vs vss v vs',
      ...
      (σ, ε, σ') ∈ Statement.reducing (Statement.receive.{u} pos chan ref) := by
    trivial
