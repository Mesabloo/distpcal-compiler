...
namespace SurfacePlusCal.Parser
  ...
  section
    variable (tryParseAnnotations : SimpleParserT (Parser.Stream.OfList (Located' (SurfaceTLAPlus.Token (Located' Token)))) (Located' (SurfaceTLAPlus.Token (Located' Token))) ParserWarningM (List CommentAnnotation))
             (parseExpression : SimpleParserT (Parser.Stream.OfList (Located' (SurfaceTLAPlus.Token (Located' Token)))) (Located' (SurfaceTLAPlus.Token (Located' Token))) ParserWarningM (Expression (List CommentAnnotation)))
