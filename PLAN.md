...
**Companion file:** `CLAUDE.md`, day-to-day working conventions.
...
question sits in §9 instead of getting decided unilaterally. Implementer hitting an
unlisted ambiguity: add it to §9, ask, don't guess.
